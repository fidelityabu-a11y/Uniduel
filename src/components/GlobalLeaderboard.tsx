...
import { getStoredLeaderboard, getStoredStats, getStoredProfile } from '../utils/storage';
import {
  Trophy,
  Medal,
  Flame,
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search duelists, universities, or specialty sections..."
                value={searchQuery}
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-[#0c1a40] text-blue-300 font-bold uppercase tracking-wider border-b border-[#182954]">
                  <tr>
                    ...
                    <th className="py-3.5 px-4 hidden md:table-cell">Best Branch</th>
